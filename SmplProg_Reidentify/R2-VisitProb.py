...
Usage:
    R2-VisitProb.py [Training Trace (in)] [Anonymized Trace (in)] [Estimated Table (out)]
"""
import numpy as np
import math
import csv
...
#sys.argv = ["R2-VisitProb.py", "../Data/testtraces_TK.csv", "../Data_Anonymized_Shuffled/testtraces_TK_A2-2-2-0.5.csv", "../Data_Reidentified/etable_TK_A2-R2.csv"]
if len(sys.argv) < 3:
