...
#sys.argv = ["T1-rand.py", "../Data/PWSCup2019_Osaka/reftraces_team001_data01_IDP.csv", "../Data_Anonymize_Shuffle/pubtraces_team001_data01_IDP_A1.csv", "../Data_TraceInfer/etraces_team001_data01_IDP_A1-T1.csv"]
if len(sys.argv) < 3:
