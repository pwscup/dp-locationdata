...
Usage:
    EvalSecT.py [Testing Trace (in)] [Anonymized Trace (in)]
"""
import numpy as np
import math
import csv
...
#sys.argv = ["EvalUtil.py", "Data/testtraces_TK.csv", "Data_Anonymized/testtraces_TK_A4-6-1.csv"]
if len(sys.argv) < 3:
    print("Usage:",sys.argv[0],"[Testing Trace (in)] [Anonymized Trace (in)]" )
    sys.exit(0)
